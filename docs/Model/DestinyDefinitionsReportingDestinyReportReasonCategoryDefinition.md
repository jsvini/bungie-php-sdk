...
**reasons** | [**map[string,\OpenAPI\Client\Model\DestinyDefinitionsReportingDestinyReportReasonDefinition]**](DestinyDefinitionsReportingDestinyReportReasonDefinition.md) | The specific reasons for the report under this category. | [optional]

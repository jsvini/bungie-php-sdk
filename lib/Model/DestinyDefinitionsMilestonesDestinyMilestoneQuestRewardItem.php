 ...
 */
class DestinyDefinitionsMilestonesDestinyMilestoneQuestRewardItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Destiny.Definitions.Milestones.DestinyMilestoneQuestRewardItem';
     ...
     * Sets vendor_hash
     *
     * @param int|null $vendor_hash The quest reward item *may* be associated with a vendor. If so, this is that vendor. Use this hash to look up the DestinyVendorDefinition.
     *
     * @return self
     */
     ...
     *
     * @param int|null $vendor_item_index The quest reward item *may* be associated with a vendor. If so, this is the index of the item being sold, which we can use at runtime to find instanced item information for the reward item.
     *
     * @return self
     */

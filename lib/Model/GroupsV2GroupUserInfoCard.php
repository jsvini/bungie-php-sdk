...
/**
 * GroupsV2GroupUserInfoCard Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GroupsV2GroupUserInfoCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPIFormats = [
        'last_seen_display_name' => null,
        'last_seen_display_name_type' => 'int32',
    ...
    protected static $setters = [
        'last_seen_display_name' => 'setLastSeenDisplayName',
        'last_seen_display_name_type' => 'setLastSeenDisplayNameType',
    ...
    protected static $getters = [
        'last_seen_display_name' => 'getLastSeenDisplayName',
        'last_seen_display_name_type' => 'getLastSeenDisplayNameType',
    ...
    {
        $this->container['last_seen_display_name'] = $data['last_seen_display_name'] ?? null;
        $this->container['last_seen_display_name_type'] = $data['last_seen_display_name_type'] ?? null;
    ...
    /**
     * Gets last_seen_display_name
     *
     * @return string|null
     */
    public function getLastSeenDisplayName()
    {
        return $this->container['last_seen_display_name'];
    }

    /**
     * Sets last_seen_display_name
     *
     * @param string|null $last_seen_display_name This will be the display name the clan server last saw the user as. If the account is an active cross save override, this will be the display name to use. Otherwise, this will match the displayName property.
     *
     * @return self
     */
    public function setLastSeenDisplayName($last_seen_display_name)
    {
        $this->container['last_seen_display_name'] = $last_seen_display_name;

        return $this;
    }

    /**
     * Gets last_seen_display_name_type
     *
     * @return int|null
     */
    public function getLastSeenDisplayNameType()
    {
        return $this->container['last_seen_display_name_type'];
    }

    /**
     * Sets last_seen_display_name_type
     *
     * @param int|null $last_seen_display_name_type The platform of the LastSeenDisplayName
     *
     * @return self
     */
    public function setLastSeenDisplayNameType($last_seen_display_name_type)
    {
        $this->container['last_seen_display_name_type'] = $last_seen_display_name_type;

...
class InlineResponse20052 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\DestinyDefinitionsDestinyEntitySearchResult',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\DestinyDefinitionsDestinyEntitySearchResult|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\DestinyDefinitionsDestinyEntitySearchResult|null $response response
     *
     * @return self
     */

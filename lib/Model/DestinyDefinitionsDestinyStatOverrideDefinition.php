...
/**
 * DestinyDefinitionsDestinyStatOverrideDefinition Class Doc Comment
 *
 * @category Class
 ...
 */
class DestinyDefinitionsDestinyStatOverrideDefinition implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets stat_hash
     *
     * @param int|null $stat_hash The hash identifier of the stat whose display properties are being overridden.
     *
     * @return self
     */
     ...
     *
     * @param DestinyDefinitionsCommonDestinyDisplayPropertiesDefinition|null $display_properties The display properties to show instead of the base DestinyStatDefinition display properties.
     *
     * @return self
     */

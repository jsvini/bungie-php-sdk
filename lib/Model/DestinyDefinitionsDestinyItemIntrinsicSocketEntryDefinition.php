 ...
 */
class DestinyDefinitionsDestinyItemIntrinsicSocketEntryDefinition implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets plug_item_hash
     *
     * @param int|null $plug_item_hash Indicates the plug that is intrinsically inserted into this socket.
     *
     * @return self
     */
     ...
     *
     * @param int|null $socket_type_hash Indicates the type of this intrinsic socket.
     *
     * @return self
     */

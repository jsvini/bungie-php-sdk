 ...
 */
class DestinyDefinitionsDestinyRaceDefinition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'race_type' => 'int',
        'gendered_race_names' => 'map[string,string]',
        'gendered_race_names_by_gender_hash' => 'map[string,string]',
        'hash' => 'int',
        'index' => 'int',
        'redacted' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'race_type' => 'int32',
        'gendered_race_names' => null,
        'gendered_race_names_by_gender_hash' => null,
        'hash' => 'uint32',
        'index' => 'int32',
        'redacted' => null
    ];
    ...
    protected static $setters = [
        ...
        'gendered_race_names' => 'setGenderedRaceNames',
        'gendered_race_names_by_gender_hash' => 'setGenderedRaceNamesByGenderHash',
        'hash' => 'setHash',
        'index' => 'setIndex',
    ...
    protected static $getters = [
        ...
        'gendered_race_names' => 'getGenderedRaceNames',
        'gendered_race_names_by_gender_hash' => 'getGenderedRaceNamesByGenderHash',
        'hash' => 'getHash',
        'index' => 'getIndex',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['gendered_race_names'] = $data['gendered_race_names'] ?? null;
        $this->container['gendered_race_names_by_gender_hash'] = $data['gendered_race_names_by_gender_hash'] ?? null;
     ...
     * Sets race_type
     *
     * @param int|null $race_type An enumeration defining the existing, known Races/Species for player characters. This value will be the enum value matching this definition.
     *
     * @return self
     */
    ...
    /**
     * Gets gendered_race_names
     *
     * @return map[string,string]|null
     */
    public function getGenderedRaceNames()
    {
        return $this->container['gendered_race_names'];
    }

    /**
     * Sets gendered_race_names
     *
     * @param map[string,string]|null $gendered_race_names A localized string referring to the singular form of the Race's name when referred to in gendered form. Keyed by the DestinyGender.
     *
     * @return self
     */
    public function setGenderedRaceNames($gendered_race_names)
    {
        $this->container['gendered_race_names'] = $gendered_race_names;

        return $this;
    }

    /**
     * Gets gendered_race_names_by_gender_hash
     *
     * @return map[string,string]|null
     */
    public function getGenderedRaceNamesByGenderHash()
    {
        return $this->container['gendered_race_names_by_gender_hash'];
    }

    /**
     * Sets gendered_race_names_by_gender_hash
     *
     * @param map[string,string]|null $gendered_race_names_by_gender_hash gendered_race_names_by_gender_hash
     *
     * @return self
     */
    public function setGenderedRaceNamesByGenderHash($gendered_race_names_by_gender_hash)
    {
        $this->container['gendered_race_names_by_gender_hash'] = $gendered_race_names_by_gender_hash;

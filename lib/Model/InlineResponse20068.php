...
class InlineResponse20068 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\CommonModelsCoreSettingsConfiguration',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\CommonModelsCoreSettingsConfiguration|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\CommonModelsCoreSettingsConfiguration|null $response response
     *
     * @return self
     */

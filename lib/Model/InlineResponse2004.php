...
class InlineResponse2004 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\UserModelsGetCredentialTypesForAccountResponse[]',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\UserModelsGetCredentialTypesForAccountResponse[]|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\UserModelsGetCredentialTypesForAccountResponse[]|null $response response
     *
     * @return self
     */

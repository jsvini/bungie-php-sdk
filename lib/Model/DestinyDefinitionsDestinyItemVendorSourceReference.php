...
/**
 * DestinyDefinitionsDestinyItemVendorSourceReference Class Doc Comment
 *
 * @category Class
 ...
 */
class DestinyDefinitionsDestinyItemVendorSourceReference implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Destiny.Definitions.DestinyItemVendorSourceReference';
     ...
     * Sets vendor_hash
     *
     * @param int|null $vendor_hash The identifier for the vendor that may sell this item.
     *
     * @return self
     */

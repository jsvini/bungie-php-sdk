 ...
 */
class DestinyHistoricalStatsDestinyHistoricalStatsValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['pga'] = $data['pga'] ?? null;
        $this->container['weighted'] = $data['weighted'] ?? null;
     ...
     * Sets stat_id
     *
     * @param string|null $stat_id Unique ID for this stat
     *
     * @return self
     */
     ...
     * Gets basic
     *
     * @return DestinyHistoricalStatsDestinyHistoricalStatsValuePair|null
     */
     ...
     * Sets basic
     *
     * @param DestinyHistoricalStatsDestinyHistoricalStatsValuePair|null $basic Basic stat value.
     *
     * @return self
     */
     ...
     * Sets pga
     *
     * @param DestinyHistoricalStatsDestinyHistoricalStatsValuePair|null $pga Per game average for the statistic, if applicable
     *
     * @return self
     */
     ...
     * Sets weighted
     *
     * @param DestinyHistoricalStatsDestinyHistoricalStatsValuePair|null $weighted Weighted value of the stat if a weight greater than 1 has been assigned.
     *
     * @return self
     */
     ...
     * Sets activity_id
     *
     * @param int|null $activity_id When a stat represents the best, most, longest, fastest or some other personal best, the actual activity ID where that personal best was established is available on this property.
     *
     * @return self
     */

...
class InlineResponse20042 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\DestinyResponsesDestinyVendorsResponse',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\DestinyResponsesDestinyVendorsResponse|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\DestinyResponsesDestinyVendorsResponse|null $response response
     *
     * @return self
     */

...
class InlineResponse20043 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\DestinyResponsesDestinyVendorResponse',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\DestinyResponsesDestinyVendorResponse|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\DestinyResponsesDestinyVendorResponse|null $response response
     *
     * @return self
     */

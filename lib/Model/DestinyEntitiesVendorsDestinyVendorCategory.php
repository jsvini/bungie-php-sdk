...
/**
 * DestinyEntitiesVendorsDestinyVendorCategory Class Doc Comment
 *
 * @category Class
 ...
 */
class DestinyEntitiesVendorsDestinyVendorCategory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['item_indexes'] = $data['item_indexes'] ?? null;
    }
     ...
     *
     * @param int|null $display_category_index An index into the DestinyVendorDefinition.displayCategories property, so you can grab the display data for this category.
     *
     * @return self
     */
    ...
    {
        return $this->container['item_indexes'];
    }

    /**
     * Sets item_indexes
     *
     * @param int[]|null $item_indexes An ordered list of indexes into items being sold in this category (DestinyVendorDefinition.itemList) which will contain more information about the items being sold themselves. Can also be used to index into DestinyVendorSaleItemComponent data, if you asked for that data to be returned.
     *
     * @return self
     */
    public function setItemIndexes($item_indexes)
    {
        $this->container['item_indexes'] = $item_indexes;

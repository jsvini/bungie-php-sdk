 ...
 */
class DestinyMilestonesDestinyMilestoneActivityVariant implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets activity_hash
     *
     * @param int|null $activity_hash The hash for the specific variant of the activity related to this milestone. You can pull more detailed static info from the DestinyActivityDefinition, such as difficulty level.
     *
     * @return self
     */
     ...
     *
     * @return DestinyMilestonesDestinyMilestoneActivityCompletionStatus|null
     */
     ...
     *
     * @param DestinyMilestonesDestinyMilestoneActivityCompletionStatus|null $completion_status An OPTIONAL component: if it makes sense to talk about this activity variant in terms of whether or not it has been completed or what progress you have made in it, this will be returned. Otherwise, this will be NULL.
     *
     * @return self
     */

...
/**
 * DestinyDefinitionsDestinyRewardSourceDefinition Class Doc Comment
 *
 * @category Class
 ...
 */
class DestinyDefinitionsDestinyRewardSourceDefinition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Destiny.Definitions.DestinyRewardSourceDefinition';
     ...
     * Sets category
     *
     * @param int|null $category Sources are grouped into categories: common ways that items are provided. I hope to see this expand in Destiny 2 once we have time to generate accurate reward source data.
     *
     * @return self
     */

...
class InlineResponse20057 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\DestinyHistoricalStatsDestinyAggregateActivityResults',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\DestinyHistoricalStatsDestinyAggregateActivityResults|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\DestinyHistoricalStatsDestinyAggregateActivityResults|null $response response
     *
     * @return self
     */

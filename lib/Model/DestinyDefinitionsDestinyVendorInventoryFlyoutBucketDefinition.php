...
/**
 * DestinyDefinitionsDestinyVendorInventoryFlyoutBucketDefinition Class Doc Comment
 *
 * @category Class
 ...
 */
class DestinyDefinitionsDestinyVendorInventoryFlyoutBucketDefinition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['collapsible'] = $data['collapsible'] ?? null;
        $this->container['inventory_bucket_hash'] = $data['inventory_bucket_hash'] ?? null;
        $this->container['sort_items_by'] = $data['sort_items_by'] ?? null;
    }
     ...
     *
     * @param int|null $inventory_bucket_hash The inventory bucket whose contents should be shown.
     *
     * @return self
     */
    ...
    {
        return $this->container['sort_items_by'];
    }

    /**
     * Sets sort_items_by
     *
     * @param int|null $sort_items_by The methodology to use for sorting items from the flyout.
     *
     * @return self
     */
    public function setSortItemsBy($sort_items_by)
    {
        $this->container['sort_items_by'] = $sort_items_by;

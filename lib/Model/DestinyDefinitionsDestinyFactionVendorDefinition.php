...
/**
 * DestinyDefinitionsDestinyFactionVendorDefinition Class Doc Comment
 *
 * @category Class
 ...
 */
class DestinyDefinitionsDestinyFactionVendorDefinition implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets vendor_hash
     *
     * @param int|null $vendor_hash The faction vendor hash.
     *
     * @return self
     */
     ...
     *
     * @param int|null $destination_hash The hash identifier for a Destination at which this vendor may be located. Each destination where a Vendor may exist will only ever have a single entry.
     *
     * @return self
     */
     ...
     *
     * @param string|null $background_image_path The relative path to the background image representing this Vendor at this location, for use in a banner.
     *
     * @return self
     */

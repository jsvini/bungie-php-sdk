...
class InlineResponse20034 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\DestinyConfigDestinyManifest',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\DestinyConfigDestinyManifest|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\DestinyConfigDestinyManifest|null $response response
     *
     * @return self
     */

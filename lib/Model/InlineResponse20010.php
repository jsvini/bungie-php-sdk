...
class InlineResponse20010 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\SearchResultOfContentItemPublicContract',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\SearchResultOfContentItemPublicContract|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\SearchResultOfContentItemPublicContract|null $response response
     *
     * @return self
     */

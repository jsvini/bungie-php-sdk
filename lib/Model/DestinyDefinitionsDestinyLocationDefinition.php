...
/**
 * DestinyDefinitionsDestinyLocationDefinition Class Doc Comment
 *
 * @category Class
 ...
 */
class DestinyDefinitionsDestinyLocationDefinition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'vendor_hash' => 'int',
        'location_releases' => '\OpenAPI\Client\Model\DestinyDefinitionsDestinyLocationReleaseDefinition[]',
        'hash' => 'int',
        'index' => 'int',
        'redacted' => 'bool'
    ];
    ...
    protected static $setters = [
        ...
        'location_releases' => 'setLocationReleases',
        'hash' => 'setHash',
        'index' => 'setIndex',
    ...
    protected static $getters = [
        ...
        'location_releases' => 'getLocationReleases',
        'hash' => 'getHash',
        'index' => 'getIndex',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['location_releases'] = $data['location_releases'] ?? null;
     ...
     * Sets vendor_hash
     *
     * @param int|null $vendor_hash If the location has a Vendor on it, this is the hash identifier for that Vendor. Look them up with DestinyVendorDefinition.
     *
     * @return self
     */
    ...
    /**
     * Gets location_releases
     *
     * @return \OpenAPI\Client\Model\DestinyDefinitionsDestinyLocationReleaseDefinition[]|null
     */
    public function getLocationReleases()
    {
        return $this->container['location_releases'];
    }

    /**
     * Sets location_releases
     *
     * @param \OpenAPI\Client\Model\DestinyDefinitionsDestinyLocationReleaseDefinition[]|null $location_releases A Location may refer to different specific spots in the world based on the world's current state. This is a list of those potential spots, and the data we can use at runtime to determine which one of the spots is the currently valid one.
     *
     * @return self
     */
    public function setLocationReleases($location_releases)
    {
        $this->container['location_releases'] = $location_releases;

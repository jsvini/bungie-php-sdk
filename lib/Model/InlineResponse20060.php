...
class InlineResponse20060 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\DestinyAdvancedAwaInitializeResponse',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\DestinyAdvancedAwaInitializeResponse|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\DestinyAdvancedAwaInitializeResponse|null $response response
     *
     * @return self
     */

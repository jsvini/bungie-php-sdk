...
class InlineResponse20012 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\ForumPostSearchResponse',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\ForumPostSearchResponse|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\ForumPostSearchResponse|null $response response
     *
     * @return self
     */

...
class InlineResponse2008 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\ContentModelsContentTypeDescription',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\ContentModelsContentTypeDescription|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\ContentModelsContentTypeDescription|null $response response
     *
     * @return self
     */

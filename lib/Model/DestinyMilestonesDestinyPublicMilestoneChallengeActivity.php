 ...
 */
class DestinyMilestonesDestinyPublicMilestoneChallengeActivity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['phase_hashes'] = $data['phase_hashes'] ?? null;
     ...
     *
     * @param int[]|null $challenge_objective_hashes challenge_objective_hashes
     *
     * @return self
     */
    ...
    {
        return $this->container['phase_hashes'];
    }

    /**
     * Sets phase_hashes
     *
     * @param int[]|null $phase_hashes The ordered list of phases for this activity, if any. Note that we have no human readable info for phases, nor any entities to relate them to: relating these hashes to something human readable is up to you unfortunately.
     *
     * @return self
     */
    public function setPhaseHashes($phase_hashes)
    {
        $this->container['phase_hashes'] = $phase_hashes;

...
class InlineResponse20035 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\DestinyDefinitionsDestinyDefinition',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\DestinyDefinitionsDestinyDefinition|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\DestinyDefinitionsDestinyDefinition|null $response response
     *
     * @return self
     */

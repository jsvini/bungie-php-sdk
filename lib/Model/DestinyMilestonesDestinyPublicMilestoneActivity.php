 ...
 */
class DestinyMilestonesDestinyPublicMilestoneActivity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'activity_hash' => 'int',
        'modifier_hashes' => 'int[]',
        'variants' => '\OpenAPI\Client\Model\DestinyMilestonesDestinyPublicMilestoneActivityVariant[]',
     ...
     * Sets activity_hash
     *
     * @param int|null $activity_hash The hash identifier of the activity that's been chosen to be considered the canonical \"conceptual\" activity definition. This may have many variants, defined herein.
     *
     * @return self
     */
     ...
     *
     * @param int[]|null $modifier_hashes The activity may have 0-to-many modifiers: if it does, this will contain the hashes to the DestinyActivityModifierDefinition that defines the modifier being applied.
     *
     * @return self
     */
     ...
     * Gets variants
     *
     * @return \OpenAPI\Client\Model\DestinyMilestonesDestinyPublicMilestoneActivityVariant[]|null
     */
     ...
     * Sets variants
     *
     * @param \OpenAPI\Client\Model\DestinyMilestonesDestinyPublicMilestoneActivityVariant[]|null $variants Every relevant variation of this conceptual activity, including the conceptual activity itself, have variants defined here.
     *
     * @return self
     */

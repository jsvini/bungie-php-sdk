...
class InlineResponse20061 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\DestinyAdvancedAwaAuthorizationResult',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\DestinyAdvancedAwaAuthorizationResult|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\DestinyAdvancedAwaAuthorizationResult|null $response response
     *
     * @return self
     */

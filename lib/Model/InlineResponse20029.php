...
class InlineResponse20029 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\GroupsV2GetGroupsForMemberResponse',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\GroupsV2GetGroupsForMemberResponse|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\GroupsV2GetGroupsForMemberResponse|null $response response
     *
     * @return self
     */

...
/**
 * DestinyDefinitionsDestinyActivityUnlockStringDefinition Class Doc Comment
 *
 * @category Class
 ...
 */
class DestinyDefinitionsDestinyActivityUnlockStringDefinition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Destiny.Definitions.DestinyActivityUnlockStringDefinition';
     ...
     * Sets display_string
     *
     * @param string|null $display_string The string to be displayed if the conditions are met.
     *
     * @return self
     */

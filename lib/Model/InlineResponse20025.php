...
class InlineResponse20025 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\GroupsV2GroupMemberLeaveResult',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\GroupsV2GroupMemberLeaveResult|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\GroupsV2GroupMemberLeaveResult|null $response response
     *
     * @return self
     */

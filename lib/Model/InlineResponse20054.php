...
class InlineResponse20054 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\DestinyHistoricalStatsDestinyHistoricalStatsAccountResult',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\DestinyHistoricalStatsDestinyHistoricalStatsAccountResult|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\DestinyHistoricalStatsDestinyHistoricalStatsAccountResult|null $response response
     *
     * @return self
     */

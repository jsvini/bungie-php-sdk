...
/**
 * DestinyAdvancedAwaUserResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DestinyAdvancedAwaUserResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets selection
     *
     * @param int|null $selection Indication of the selection the user has made (Approving or rejecting the action)
     *
     * @return self
     */
     ...
     * Sets correlation_id
     *
     * @param string|null $correlation_id Correlation ID of the request
     *
     * @return self
     */

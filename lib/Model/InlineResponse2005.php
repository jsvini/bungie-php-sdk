...
class InlineResponse2005 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\ConfigUserTheme[]',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\ConfigUserTheme[]|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\ConfigUserTheme[]|null $response response
     *
     * @return self
     */

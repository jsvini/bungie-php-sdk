...
class InlineResponse20058 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\DestinyMilestonesDestinyMilestoneContent',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\DestinyMilestonesDestinyMilestoneContent|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\DestinyMilestonesDestinyMilestoneContent|null $response response
     *
     * @return self
     */

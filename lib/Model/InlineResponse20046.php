...
class InlineResponse20046 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\DestinyDestinyEquipItemResults',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\DestinyDestinyEquipItemResults|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\DestinyDestinyEquipItemResults|null $response response
     *
     * @return self
     */

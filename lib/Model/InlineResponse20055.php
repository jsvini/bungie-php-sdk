...
class InlineResponse20055 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\DestinyHistoricalStatsDestinyActivityHistoryResults',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\DestinyHistoricalStatsDestinyActivityHistoryResults|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\DestinyHistoricalStatsDestinyActivityHistoryResults|null $response response
     *
     * @return self
     */

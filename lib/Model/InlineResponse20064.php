...
class InlineResponse20064 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\TrendingTrendingDetail',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\TrendingTrendingDetail|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\TrendingTrendingDetail|null $response response
     *
     * @return self
     */

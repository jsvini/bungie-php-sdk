...
/**
 * DestinyDefinitionsItemsDestinyEnergyCapacityEntry Class Doc Comment
 *
 * @category Class
 ...
 */
class DestinyDefinitionsItemsDestinyEnergyCapacityEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['capacity_value'] = $data['capacity_value'] ?? null;
     ...
     * Sets capacity_value
     *
     * @param int|null $capacity_value How much energy capacity this plug provides.
     *
     * @return self
     */
     ...
     *
     * @param int|null $energy_type_hash Energy provided by a plug is always of a specific type - this is the hash identifier for the energy type for which it provides Capacity.
     *
     * @return self
     */
     ...
     * Sets energy_type
     *
     * @param int|null $energy_type The Energy Type for this energy capacity, in enum form for easy use.
     *
     * @return self
     */

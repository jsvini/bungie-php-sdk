...
/**
 * DestinyDefinitionsBreakerTypesDestinyBreakerTypeDefinition Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DestinyDefinitionsBreakerTypesDestinyBreakerTypeDefinition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Destiny.Definitions.BreakerTypes.DestinyBreakerTypeDefinition';
     ...
     * Sets enum_value
     *
     * @param int|null $enum_value We have an enumeration for Breaker types for quick reference. This is the current definition's breaker type enum value.
     *
     * @return self
     */

...
class InlineResponse20065 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\SearchResultOfFireteamSummary',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\SearchResultOfFireteamSummary|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\SearchResultOfFireteamSummary|null $response response
     *
     * @return self
     */

...
class InlineResponse2007 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\UserHardLinkedUserMembership',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\UserHardLinkedUserMembership|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\UserHardLinkedUserMembership|null $response response
     *
     * @return self
     */

...
class InlineResponse20040 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\DestinyMilestonesDestinyMilestone',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\DestinyMilestonesDestinyMilestone|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\DestinyMilestonesDestinyMilestone|null $response response
     *
     * @return self
     */

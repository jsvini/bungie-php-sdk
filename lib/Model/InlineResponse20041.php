...
class InlineResponse20041 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\DestinyResponsesDestinyItemResponse',
        'error_code' => 'int',
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\DestinyResponsesDestinyItemResponse|null $response response
     *
     * @return self
     */

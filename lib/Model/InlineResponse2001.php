...
class InlineResponse2001 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\ApplicationsApplication[]',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\ApplicationsApplication[]|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\ApplicationsApplication[]|null $response response
     *
     * @return self
     */

...
class InlineResponse20031 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\GroupsV2GroupPotentialMembershipSearchResponse',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\GroupsV2GroupPotentialMembershipSearchResponse|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\GroupsV2GroupPotentialMembershipSearchResponse|null $response response
     *
     * @return self
     */

...
class InlineResponse20033 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\TokensPartnerOfferSkuHistoryResponse[]',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\TokensPartnerOfferSkuHistoryResponse[]|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\TokensPartnerOfferSkuHistoryResponse[]|null $response response
     *
     * @return self
     */

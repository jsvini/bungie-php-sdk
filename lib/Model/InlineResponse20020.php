...
class InlineResponse20020 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\GroupsV2GroupSearchResponse',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\GroupsV2GroupSearchResponse|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\GroupsV2GroupSearchResponse|null $response response
     *
     * @return self
     */

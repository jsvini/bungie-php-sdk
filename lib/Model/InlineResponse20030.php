...
class InlineResponse20030 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\GroupsV2GroupMembershipSearchResponse',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\GroupsV2GroupMembershipSearchResponse|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\GroupsV2GroupMembershipSearchResponse|null $response response
     *
     * @return self
     */

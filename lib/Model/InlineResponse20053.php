...
class InlineResponse20053 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => 'map[string,\OpenAPI\Client\Model\DestinyHistoricalStatsDestinyHistoricalStatsByPeriod]',
        'error_code' => 'int',
     ...
     * Sets response
     *
     * @param map[string,\OpenAPI\Client\Model\DestinyHistoricalStatsDestinyHistoricalStatsByPeriod]|null $response response
     *
     * @return self
     */

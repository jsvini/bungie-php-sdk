...
/**
 * DestinyResponsesDestinyPublicVendorsResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class DestinyResponsesDestinyPublicVendorsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Gets vendors
     *
     * @return DictionaryComponentResponseOfuint32AndDestinyPublicVendorComponent|null
     */
     ...
     * Sets vendors
     *
     * @param DictionaryComponentResponseOfuint32AndDestinyPublicVendorComponent|null $vendors The base properties of the vendor. These are keyed by the Vendor Hash, so you will get one Vendor Component per vendor returned.  COMPONENT TYPE: Vendors
     *
     * @return self
     */
     ...
     * Gets sales
     *
     * @return DictionaryComponentResponseOfuint32AndPublicDestinyVendorSaleItemSetComponent|null
     */
     ...
     * Sets sales
     *
     * @param DictionaryComponentResponseOfuint32AndPublicDestinyVendorSaleItemSetComponent|null $sales Sales, keyed by the vendorItemIndex of the item being sold. These are keyed by the Vendor Hash, so you will get one Sale Item Set Component per vendor returned.  Note that within the Sale Item Set component, the sales are themselves keyed by the vendorSaleIndex, so you can relate it to the corrent sale item definition within the Vendor's definition.  COMPONENT TYPE: VendorSales
     *
     * @return self
     */

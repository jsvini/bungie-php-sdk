...
class InlineResponse20027 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\SearchResultOfGroupMemberApplication',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\SearchResultOfGroupMemberApplication|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\SearchResultOfGroupMemberApplication|null $response response
     *
     * @return self
     */

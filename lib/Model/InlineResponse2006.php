...
class InlineResponse2006 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\UserUserMembershipData',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\UserUserMembershipData|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\UserUserMembershipData|null $response response
     *
     * @return self
     */

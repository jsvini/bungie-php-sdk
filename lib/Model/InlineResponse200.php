...
class InlineResponse200 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\ApplicationsApiUsage',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\ApplicationsApiUsage|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\ApplicationsApiUsage|null $response response
     *
     * @return self
     */

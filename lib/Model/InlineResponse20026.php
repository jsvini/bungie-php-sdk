...
class InlineResponse20026 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\SearchResultOfGroupBan',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\SearchResultOfGroupBan|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\SearchResultOfGroupBan|null $response response
     *
     * @return self
     */

...
/**
 * DestinyDefinitionsItemsDestinyPlugRuleDefinition Class Doc Comment
 *
 * @category Class
 ...
 */
class DestinyDefinitionsItemsDestinyPlugRuleDefinition implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string|null $failure_message The localized string to show if this rule fails.
     *
     * @return self
     */

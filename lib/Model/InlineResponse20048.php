...
class InlineResponse20048 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\DestinyHistoricalStatsDestinyPostGameCarnageReportData',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\DestinyHistoricalStatsDestinyPostGameCarnageReportData|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\DestinyHistoricalStatsDestinyPostGameCarnageReportData|null $response response
     *
     * @return self
     */

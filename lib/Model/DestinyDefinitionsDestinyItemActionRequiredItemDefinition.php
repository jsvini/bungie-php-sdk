 ...
 */
class DestinyDefinitionsDestinyItemActionRequiredItemDefinition implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets item_hash
     *
     * @param int|null $item_hash The hash identifier of the item you need to have. Use it to look up the DestinyInventoryItemDefinition for more info.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $delete_on_action If true, the item/quantity will be deleted from your inventory when the action is performed. Otherwise, you'll retain these required items after the action is complete.
     *
     * @return self
     */

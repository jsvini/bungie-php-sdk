 ...
 */
class DestinyRequestsActionsDestinyInsertPlugsActionRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets action_token
     *
     * @param string|null $action_token Action token provided by the AwaGetActionToken API call.
     *
     * @return self
     */
     ...
     *
     * @param int|null $item_instance_id The instance ID of the item having a plug inserted. Only instanced items can have sockets.
     *
     * @return self
     */

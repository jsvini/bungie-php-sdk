 ...
 */
class DestinyDestinyEquipItemResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['equip_status'] = $data['equip_status'] ?? null;
    }
     ...
     *
     * @param int|null $item_instance_id The instance ID of the item in question (all items that can be equipped must, but definition, be Instanced and thus have an Instance ID that you can use to refer to them)
     *
     * @return self
     */
    ...
    {
        return $this->container['equip_status'];
    }

    /**
     * Sets equip_status
     *
     * @param int|null $equip_status A PlatformErrorCodes enum indicating whether it succeeded, and if it failed why.
     *
     * @return self
     */
    public function setEquipStatus($equip_status)
    {
        $this->container['equip_status'] = $equip_status;

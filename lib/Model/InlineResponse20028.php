...
class InlineResponse20028 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\EntitiesEntityActionResult[]',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\EntitiesEntityActionResult[]|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\EntitiesEntityActionResult[]|null $response response
     *
     * @return self
     */

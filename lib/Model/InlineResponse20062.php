...
class InlineResponse20062 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\TrendingTrendingCategories',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\TrendingTrendingCategories|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\TrendingTrendingCategories|null $response response
     *
     * @return self
     */

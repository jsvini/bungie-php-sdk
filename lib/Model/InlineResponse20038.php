...
class InlineResponse20038 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\DestinyResponsesDestinyProfileResponse',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\DestinyResponsesDestinyProfileResponse|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\DestinyResponsesDestinyProfileResponse|null $response response
     *
     * @return self
     */

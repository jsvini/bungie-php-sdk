...
/**
 * DestinyDefinitionsItemsDestinyEnergyCostEntry Class Doc Comment
 *
 * @category Class
 ...
 */
class DestinyDefinitionsItemsDestinyEnergyCostEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets energy_cost
     *
     * @param int|null $energy_cost The Energy cost for inserting this plug.
     *
     * @return self
     */
     ...
     *
     * @param int|null $energy_type_hash The type of energy that this plug costs, as a reference to the DestinyEnergyTypeDefinition of the energy type.
     *
     * @return self
     */
     ...
     * Sets energy_type
     *
     * @param int|null $energy_type The type of energy that this plug costs, in enum form.
     *
     * @return self
     */

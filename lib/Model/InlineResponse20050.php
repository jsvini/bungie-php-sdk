...
class InlineResponse20050 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => 'map[string,map[string,\OpenAPI\Client\Model\DestinyHistoricalStatsDestinyLeaderboard]]',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return map[string,map[string,\OpenAPI\Client\Model\DestinyHistoricalStatsDestinyLeaderboard]]|null
     */
     ...
     * Sets response
     *
     * @param map[string,map[string,\OpenAPI\Client\Model\DestinyHistoricalStatsDestinyLeaderboard]]|null $response response
     *
     * @return self
     */

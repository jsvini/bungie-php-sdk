...
/**
 * GroupsV2GroupOptionalConversationEditRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GroupsV2GroupOptionalConversationEditRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GroupsV2.GroupOptionalConversationEditRequest';
    ...
    {
        $this->container['chat_enabled'] = $data['chat_enabled'] ?? null;
        $this->container['chat_name'] = $data['chat_name'] ?? null;

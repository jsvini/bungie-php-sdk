...
class InlineResponse20017 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\ConfigGroupTheme[]',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\ConfigGroupTheme[]|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\ConfigGroupTheme[]|null $response response
     *
     * @return self
     */

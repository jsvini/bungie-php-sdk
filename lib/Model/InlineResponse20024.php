...
class InlineResponse20024 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'response' => '\OpenAPI\Client\Model\SearchResultOfGroupMember',
        'error_code' => 'int',
     ...
     * Gets response
     *
     * @return \OpenAPI\Client\Model\SearchResultOfGroupMember|null
     */
     ...
     * Sets response
     *
     * @param \OpenAPI\Client\Model\SearchResultOfGroupMember|null $response response
     *
     * @return self
     */
